    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.TextField(choices=[('pending', 'pending'), ('exporting', 'exporting'), ('cancelled', 'cancelled'), ('complete', 'complete'), ('failed', 'failed'), ('expired', 'expired')])),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['created_at', 'user', 'status'], name='database_ex_created_6af425_idx'),
        ),
    ]
