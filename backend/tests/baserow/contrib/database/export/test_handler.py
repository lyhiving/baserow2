...
def test_can_export_simple_view_to_simple_csv(storage_mock, data_fixture):
    ...
    expected = (
        "\ufeff"
        "ID,text_field,option_field,date_field,Customer\r\n"
        "2,atest,A,02/01/2020 01:23,link-other-test\r\n"
        '1,test,B,02/01/2020 01:23,"link-test,link-other-test"\r\n'
    )
